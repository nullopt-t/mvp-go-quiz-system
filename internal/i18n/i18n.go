...
var translations = map[Language]map[string]string{
	LangEN: {
		...
		"admin_hierarchy_title":"Cohort Overview",
		"admin_hierarchy_sub":  "5 Levels • Groups A, B, C, D",
		"admin_enrolled":       "Students",
		"admin_cohort_total":  "Total",
	...
	LangAR: {
		...
		"admin_hierarchy_title":"توزيع المستويات والمجموعات",
		"admin_hierarchy_sub":  "5 مستويات • المجموعات A, B, C, D",
		"admin_enrolled":       "الطلاب",
		"admin_cohort_total":  "الإجمالي",
		...
		"admin_filter_cohort":  "تصفية وترتيب القائمة",
		"filter_and_sort":      "تصفية وترتيب",
		"apply_filters":        "تطبيق التصفية والترتيب",
		"close_dialog":         "إغلاق",
